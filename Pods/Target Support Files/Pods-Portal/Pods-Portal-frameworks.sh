...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HdWalletKit.swift/HdWalletKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Hodler.swift/Hodler.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HsToolKit.swift/HsToolKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftNIOWebSocket/NIOWebSocket.framework"
